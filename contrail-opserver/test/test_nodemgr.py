...
class NodemgrTest(unittest.TestCase):
    ...
    @mock.patch('nodemgr.common.docker_process_manager.ContainerProcessInfoManager')
    @mock.patch('nodemgr.common.docker_process_manager.ContainerProcessInfoManager.get_all_processes')
