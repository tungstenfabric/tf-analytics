...
class AnalyticsUveTest(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    def test_05_collector_ha(self):
        ...
        # to collectors[1]
        logging.info('Aadarsh: Stopping collector 0. Collector 1 is up')
        ...
        logging.info('Aadarsh: Callg verify_generator_list at line 266. Collector 0 is stopped. Collector 1 is stopped')
        ...
        # to collectors[0]
        logging.info('Aadarsh: Stopping collector 1. Collector 0 is up')
        ...
        # to the collector
        logging.info('Aadarsh: Stopping Collector 0 at340. Now both collectors are down')
        vizd_obj.collectors[0].stop()
        ...
        logging.info('Aadarsh: Starting collector 1 at line 357. Collector 1 is up. Collector 0 is down')
    ...
    def test_19_redis_ha(self):
        ...
        logging.info('Aadarsh: timeout for 1 second')
        time.sleep(1)
        assert generator_obj.verify_vm_uve(vm_id='abcd',
                                           num_vm_ifs=5,
                                           msg_count=5)
        ...
        logging.info('Aadarsh: Stopped redis 1. Redis 0 is up')
        logging.info('Aadarsh: timeout for 1 second')
        time.sleep(1)
        assert generator_obj.verify_vm_uve(vm_id='abcd',
                                           num_vm_ifs=5,
