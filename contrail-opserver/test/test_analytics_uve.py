...
class AnalyticsUveTest(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    def test_05_collector_ha(self):
        ...
        logging.info('Aadarsh: Starting collector 1 at line 357')
    ...
    def test_19_redis_ha(self):
        ...
        assert generator_obj.verify_vm_uve(vm_id='abcd',
                                           num_vm_ifs=5,
                                           msg_count=5)
        logging.info('Aadarsh: Starting redis 0 after sleep for 20seconds')
        time.sleep(20)
        vizd_obj.redis_uves[0].start()
        ...
        assert generator_obj.verify_vm_uve(vm_id='abcd',
                                           num_vm_ifs=5,
                                           msg_count=5)
        logging.info('Aadarsh: Starting redis 1 after sleep for 20seconds')
        time.sleep(20)
