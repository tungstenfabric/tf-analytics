...
void Options::Initialize(EventManager &evm,
    ...
    zookeeper_config.add_options()
        ...
        ("ZOOKEEPER.zookeeper_ssl_keyfile", opt::value<std::string>()->default_value(
         "/etc/contrail/ssl/private/server-privkey.pem"),
         "zookeeper SSL private key")
        ("ZOOKEEPER.zookeeper_ssl_certfile", opt::value<std::string>()->default_value(
         "/etc/contrail/ssl/certs/server.pem"),
         "zookeeper SSL certificate")
        ("ZOOKEEPER.zookeeper_ssl_ca_cert", opt::value<std::string>()->default_value(
         "/etc/contrail/ssl/certs/ca-cert.pem"),
...
void Options::Process(int argc, char *argv[],
    ...
    if(zookeeper_options_.ssl_enable) {
        ...
        cout << "Pankaj jee    ====  "<<all_zoo_cert_files<<endl;
