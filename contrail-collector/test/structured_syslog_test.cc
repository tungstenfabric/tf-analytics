...
TEST_F(StructuredSyslogStatWalkerTest, MessageLengthSplit_1) {
    ...
    test_structured_syslog_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_MessageLengthSplit_1.txt");
    ...
    test_structured_syslog_rest_of_buffer_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_rest_of_buffer_MessageLengthSplit_1.txt");
    std::getline (test_structured_syslog_rest_of_buffer_File, test_structured_syslog_rest_of_buffer);
...
TEST_F(StructuredSyslogStatWalkerTest, MessageLengthSplit_2) {
    ...
    std::ifstream test_structured_syslog_File;
    test_structured_syslog_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_MessageLengthSplit_2.txt");
    std::getline (test_structured_syslog_File, test_structured_syslog);
 
    std::ifstream test_structured_syslog_rest_of_buffer_File;
    test_structured_syslog_rest_of_buffer_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_rest_of_buffer_MessageLengthSplit_2.txt");
    std::getline (test_structured_syslog_rest_of_buffer_File, test_structured_syslog_rest_of_buffer);
...
TEST_F(StructuredSyslogStatWalkerTest, MessageLengthSplit_3) {
    ...
    std::ifstream test_structured_syslog_File;
    test_structured_syslog_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_MessageLengthSplit_3.txt");
    std::getline (test_structured_syslog_File, test_structured_syslog);
 
    std::ifstream test_structured_syslog_rest_of_buffer_File;
    test_structured_syslog_rest_of_buffer_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_rest_of_buffer_MessageLengthSplit_3.txt");
    std::getline (test_structured_syslog_rest_of_buffer_File, test_structured_syslog_rest_of_buffer);
...
TEST_F(StructuredSyslogStatWalkerTest, MessageLengthBad) {
    ...
    std::ifstream test_structured_syslog_File;
    test_structured_syslog_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_MessageLengthBad.txt");
    std::getline (test_structured_syslog_File, test_structured_syslog);
    std::ifstream test_structured_syslog_rest_of_buffer_File;
    test_structured_syslog_rest_of_buffer_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_rest_of_buffer_MessageLengthBad.txt");
    std::getline (test_structured_syslog_rest_of_buffer_File, test_structured_syslog_rest_of_buffer);
    test_structured_syslog_rest_of_buffer_File.close();
    test_structured_syslog_File.close();
...
TEST_F(StructuredSyslogStatWalkerTest, SNMP_TRAPSyslog) {
    ...
    std::ifstream test_structured_syslog_File;
    test_structured_syslog_File.open(
        "./src/contrail-analytics/contrail-collector/test/test_structured_syslog_SNMP_TRAPSyslog.txt");
    std::getline (test_structured_syslog_File, test_structured_syslog); 
    test_structured_syslog_File.close();
